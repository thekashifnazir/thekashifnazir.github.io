...
ShowToc: false
focus_areas:
  - "Cloud architecture and migration planning (AWS, Azure)"
  - "Kubernetes, Linux, and platform engineering"
  - "Infrastructure automation with Python and Terraform"
  - "AI evaluation, adoption, and integration into engineering workflows"
  - "Bridging the gap between business intent and technical implementation"
proof_points:
  - label: "Orientation"
    value: "Business context first, engineering depth when needed"
  - label: "Current stack"
    value: "AWS, Kubernetes, Linux, Python, Terraform"
  - label: "Format"
    value: "Static-first publishing with Hugo"
contact_links:
  - label: "Email"
    value: "contact@kashifnazir.com"
    url: "mailto:contact@kashifnazir.com"
  - label: "GitHub"
    value: "@thekashifnazir"
    url: "https://github.com/thekashifnazir"
---
