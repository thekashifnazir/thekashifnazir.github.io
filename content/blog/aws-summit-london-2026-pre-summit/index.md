...
{{< figure src="session-decision-flowchart.svg" alt="Flowchart showing four session options with Kiro and VMware selected, Keynote and Zero Trust deprioritised" >}}
...
{{< figure src="conference-stage.jpg" alt="Conference stage with blue lighting and a cameraman filming" >}}
...
{{< figure src="conference-hall.jpg" alt="Packed conference hall with hundreds of attendees watching a speaker on stage" >}}
...
{{< figure src="f1-pit-lane-aws.jpg" alt="Red Bull F1 car in the pit lane with AWS branding on the barriers" >}}
...
{{< figure src="application-layer-gap.png" alt="Modern cloud infrastructure stack with a crumbling legacy application layer sitting on top, illustrating the gap between infrastructure and applications" >}}
