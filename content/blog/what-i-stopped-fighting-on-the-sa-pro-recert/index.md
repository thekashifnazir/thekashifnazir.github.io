...
{{< figure src="onenote-to-notion.png" link="onenote-to-notion.png" target="_blank" rel="noopener noreferrer" alt="A comparison graphic showing OneNote copy-paste friction on the left and Notion API-based editing on the right" caption="The change that mattered was removing the copy-paste bridge between where the AI worked and where the notes lived." >}}
...
{{< figure src="where-my-time-went.png" link="where-my-time-went.png" target="_blank" rel="noopener noreferrer" alt="A hand-drawn time breakdown showing project setup, usage reset waiting, structure fixes, slide handling, manual diagram work, and actual note generation" caption="The clock time was not magic. The useful part was that a lot of it happened asynchronously instead of taking my focus." >}}
...
{{< figure src="event-driven-workflow-azure-aws.png" link="event-driven-workflow-azure-aws.png" target="_blank" rel="noopener noreferrer" alt="Side-by-side Azure and AWS event-driven workflow diagram using API Management, API Gateway, Event Grid, EventBridge, Functions, and Lambda" caption="The redesign in my head is less about copying services and more about translating the event pattern into AWS primitives." >}}
